...
from sqlalchemy import Column, Boolean, Integer, Float, String, DateTime, TIMESTAMP
...
class FrontDoor2706(BaseTable, Base):  # 前門風扇，改fan_0,fan_1
    ...
    fan3 = Column(String(40), nullable=False)  # right
    fan4 = Column(String(40), nullable=False)  # left
...
class BackDoor2706(BaseTable, Base):  # 後門風扇
    ...
    co2 = Column(Float(6, 2), nullable=False)
    tvoc = Column(Float(6, 2), nullable=False)
    fan1 = Column(String(40), nullable=False)  # right
    fan2 = Column(String(40), nullable=False)  # left
...
if __name__ == "__main__":
    ...
    if os.path.exists(dotenv_path):
        load_dotenv(
            f"{os.path.dirname(os.path.abspath(__file__))}/.env", override=True)
